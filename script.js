document.addEventListener('DOMContentLoaded', function () {
  ...
  const xlsxTimeline = [
    ...
    { "Frame": 5,  "Title": "2000", "H1Copy": "First private sector project", "BodyCopy": "India Inc. bought into the promise of wind energy when Suzlon won Tata Finance's turnkey wind farm project to reduce its power costs and carbon footprint alike. <br>The journey from one customer to over 1,900.", "H2Copy-2": "Trust built, one turbine at a time.<br>CONTINUE." },
    ...
    { "Frame": 11, "Title": "2003", "H1Copy": "Asia's largest wind farm in Maharashtra", "BodyCopy": "Suzlon set global benchmarks by building Asia's largest wind farm at Vankusawade, Maharashtra - going from single turbines to utility scale windfarms – changing the game once again as wind became an excellent investment opportunity for India Inc. and investors", "H2Copy-2": "From one turbine to wind farms to power plants.<br>CONTINUE." },
    { "Frame": 12, "Title": "2004", "H1Copy": "Introducing China to wind manufacturing", "BodyCopy": "Suzlon established China's first wind energy manufacturing facility in Tianjin at a time when the country only imported wind turbines. Spotting the opportunity ahead of time, Suzlon brought affordable clean energy solutions to millions.", "H2Copy-2": "Building a sustainable world, one nation at a time.<br>CONTINUE." },
